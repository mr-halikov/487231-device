...
##### header
- исправить баг с сабмитом формы поиска

##### Блок слайдер
~~ Оформление слайда 2 ~~
~~ Оформление слайда 3 ~~

##### Блок популярные продукты:
- состояние active

##### Блок сервисы:
~~ исправить 100vw (horizontal scroll) ~~

##### Блок бренды:
- Заменить картинки в блоке
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/487231-device) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
